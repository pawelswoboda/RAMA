...
PYBIND11_MODULE(parallel_gaec_py, m) {
    ...
    m.def("parallel_gaec_eigen", [](const Eigen::Array<size_t, Eigen::Dynamic, 2>& edge_indices, const Eigen::Array<double, Eigen::Dynamic, 1>& edge_costs, const double contract_ratio, const size_t num_itr) {
        ...
        return parallel_gaec(e, contract_ratio, num_itr); 
    });
}
