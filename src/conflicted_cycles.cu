...
std::tuple<thrust::device_vector<int>, thrust::device_vector<int>, thrust::device_vector<int>> conflicted_cycles::filter_self_intersecting_paths(
...
std::tuple<thrust::device_vector<int>, thrust::device_vector<int>, thrust::device_vector<int>> 
    conflicted_cycles::expand_frontier(const thrust::device_vector<int>& v_parent_edges, const thrust::device_vector<int>& v_frontier, 
        const device_vectors& expanded_paths, const device_vectors& expanded_paths_parent_edges)
{
    MEASURE_CUMULATIVE_FUNCTION_EXECUTION_TIME
